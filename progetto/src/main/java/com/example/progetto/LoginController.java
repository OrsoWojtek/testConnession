...
public class LoginController {
    ...
    public void checkLogin(LoginInfoBean curr_log) {
        ...
        curr_log.setCheck(logdb.isRegistered(curr_log.getUsername(), curr_log.getPassword()));  //Setting del check del bean in base alla presenza o meno delle credenziali ricercate nel DAO
    }
}
